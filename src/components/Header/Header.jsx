...
const Header = () => {
    ...
    if (location.includes('/sign')) return null;
    return (
        <header className="header">
            <div className="header__container">
                <div className="header__logo">
                    ...
                    {!location.includes('/plate') && <h1 className="header__title">{location === '/' ? 'наша продукция' : 'Корзина с выбранными товарами'}</h1>}
                </div>
                <div className="header__actions">
                    {location !== '/cart' && <div className="header__basket">
                        <p className="header__basket-description">
